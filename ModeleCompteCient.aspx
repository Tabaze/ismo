<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModeleCompteCient.aspx.cs" Inherits="ModeleCompteCient" %>
...
<head runat="server">
    ...
    <title>Modèle de Compte Client</title>
...
<body class="bgModel">
            ...
            <div class="row top-header text-white">
                ...
                <div class="col-6 col-md-7 menu-selector">
                    <ul class="nav h-100 user-select-none" id="menu-header" role="menu">
                        <li class="nav-item px-2 d-flex align-items-center" title="Document Client" data-model="DocClient">
                            <span>Document Client</span>
                        </li>
                        <li class="nav-item px-2 d-flex align-items-center" title="Document client Detaillé" data-model="DocClientDetail">
                            <span>Document client Detaillé</span>
                        </li>
                        <li class="nav-item px-2 d-flex align-items-center" title="Grand Livre Client" data-model="GrandLiveClient">
                            <span>Grand Livre Client</span>
                        </li>
                        <li class="nav-item px-2 d-flex align-items-center" title="Balance Clients" data-model="SoldeCreditClient">
                            <span>Balance Clients</span>
                        </li>
                    </ul>
                </div>
        ...
        <section class="screen-afficher screen mt-1">
                ...
                <div class="col-6 classFilter">
                    <div class="form-outline mb-3 mt-4">
                        <div class="d-inline-block bg-white w-25">
                            <select class="form-select d-inline-block" id="idClient">  
                            </select>
                        </div>
            ...
            <div class="row">
                <div class="col-6 card m-auto">
                    ...
                    <table class="w-100 totalTableDocClient d-none">
                        <tbody>
                            <tr>
                                <td>Total HT page :</td>
                    ...
                    <table class="w-100 totalTableDocClientDetail d-none">
                        <tbody>
                            <tr>
                                <td>Total HT page :</td>
                                <td class="HT_Page" style="border-right: 1px solid #dfdfdf;">...</td>
    ...
    <script src="../js/ModeleCompteCient/custom.js"></script>
    <script type="module" src="../js/ModeleCompteCient/core.js"></script> 
</body>
</html>
