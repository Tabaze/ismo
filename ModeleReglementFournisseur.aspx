<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModeleReglementFournisseur.aspx.cs" Inherits="ModeleReglementFournisseur" %>
...
<body class="bgModel">
    <div class="container-fluid h-100">
            ...
            <div class="row top-header text-white">
                ...
                <div class="col-6 col-md-7 menu-selector">
                    <ul class="nav h-100 user-select-none" id="menu-header" role="menu">
                        <li class="nav-item px-2 d-flex align-items-center" title="ESPECE" data-model="ESPF">
                            <span>Espèce</span>
                        </li>
                        <li class="nav-item px-2 d-flex align-items-center" title="Chèque" data-model="CHFFF">
                            <span>Chèque</span>
                        </li>
                        <li class="nav-item px-2 d-flex align-items-center" title="Effet_de_commerce" data-model="EFFETFR">
                            <span>Effet_de_commerce</span>
                        </li>
                        <li class="nav-item px-2 d-flex align-items-center" title="Virement_bancaire" data-model="VRMBNQFR">
                            <span>Virement_bancaire</span>
                        </li>
                        <li class="nav-item px-2 d-flex align-items-center" title="Prélèvement" data-model="PRLFR">
                            <span>Prélèvement</span>
                        </li>
                        <li class="nav-item px-2 d-flex align-items-center" title="Payés" data-model="PYF">
                            <span>Payés</span>
                        </li>
                        <li class="nav-item px-2 d-flex align-items-center" title="Impayés" data-model="IPYF">
                            <span>Impayés</span>
                        </li>
                        <li class="nav-item px-2 d-flex align-items-center" title="Rendu" data-model="RNDF">
                            <span>Rendu</span>
                        </li>
                    </ul>
                </div>
            ...
            <div class="row mt-3">
                <div class="col-6">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="copierVers" id="listCopier">
                        <li><button class="dropdown-item" data-model="PYF">Payés</button></li>
                        <li><button class="dropdown-item" data-model="IPYF">Impayés</button></li>
                    </ul>
                </div>
        ...
        <section class="screen-create d-none screen mt-3 ReglementFournisseur">
            <div class="row">
                <div class="col-4">
                    <h2 id="breadcrumb">Réglement Fournisseur</h2>
                </div>
            </div>
            <div class="row mt-3">
                <div class="col-md-6">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-4">      
                            ...
                            <div class="form-outline mb-3">
                                ...
                                <label class="form-label" for="numCheque">Numéro de chéque</label>
                            </div>       
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="idFournisseur" class="form-label">Compte Fournisseur</label>
    ...
    <script src="../js/ModeleRegFournisseur/custom.js"></script>
    <script type="module" src="../js/ModeleRegFournisseur/core.js"></script>
</body>
</html>
