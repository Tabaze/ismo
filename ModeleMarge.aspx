<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModeleMarge.aspx.cs" Inherits="ModeleMarge" %>
...
<body class="bgModel">
            ...
            <div class="row top-header text-white">
                ...
                <div class="col-6 col-md-7 menu-selector">
                    <ul class="nav h-100 user-select-none" id="menu-header" role="menu">
                        <li class="nav-item px-2 d-flex align-items-center" title="Etat Vente par Article" data-model="parArticle">
                            <span>Etat Vente par Article</span>
                        </li>
                        <li class="nav-item px-2 d-flex align-items-center" title="Etat Vente par Famille" data-model="parFamille">
                            <span>Etat Vente par Famille</span>
                        </li>
                        <li class="nav-item px-2 d-flex align-items-center" title="Etat Vente par Client" data-model="parClient">
                            <span>Etat Vente par Client</span>
                        </li>
                        <li class="nav-item px-2 d-flex align-items-center" title="Etat Vente par Ville" data-model="parVille">
    ...
    <script src="../js/ModeleMarge/custom.js"></script>
    <script type="module" src="../js/ModeleMarge/core.js"></script> 
</body>
</html>
