$(document).ready(function() {
    ...
    $.screenReglement = $('.screen-create.screen.ReglementClient');
    ...
    $('#pdf').on('click',this,function(){
        ...
        switch (ittone.getSubMenu()) {
            case 'ESPC': titel = '<tr><td>ESPECE</td></tr>'; break;
            case 'CHFFC': titel = '<tr><td>CHEQUE</td></tr>'; break;
            case 'EFFETCL': titel = '<tr><td>EFFET DE COMMERCE</td></tr>'; break;
            case 'VRMBNQCL': titel = '<tr><td>VIREMENT BANCAIRE</td></tr>'; break;
            case 'PRLCL': titel = '<tr><td>PRELEVEMENT</td></tr>'; break;
            case 'PYC': titel = '<tr><td>PAYES</td></tr>'; break;
            case 'IPYC': titel = '<tr><td>IMPAYES</td></tr>'; break;
            case 'RNDC': titel = '<tr><td>RENDU</td></tr>'; break;
        }
        let columns_title = [
